...
public class Simplex {
    ...
    public static void main(String[] args) {
        ...
        double[] objectiveFuncMax = {62, 82, 69, 42, 56};
        double[][] constraintLeftSideMax = {
                {16, 12, 5, 19, 2},
                {7, 9, 8, 4, 17},
                {14, 21, 12, 5, 10},
                {0, 2, 3, 11, 7},
                {15, 4, 17, 4, 8}};
        Constraint[] constraintOperatorMax = {Constraint.lessThan,
                Constraint.lessThan, Constraint.lessThan, Constraint.lessThan, Constraint.lessThan};
        double[] constraintRightSideMax = {1700, 1800, 1400, 1400, 1600};

        double[] objectiveFunc = objectiveFuncMax;
        double[][] constraintLeftSide = constraintLeftSideMax;
        Constraint[] constraintOperator = constraintOperatorMax;
        double[] constraintRightSide = constraintRightSideMax;
